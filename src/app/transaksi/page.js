...
export default function Home() {
  ...
  const fetchKategori = async () => {
    try {
      ...
      if (data.length > 0 && !formData.kategori_id) {
        setFormData(prev => ({ ...prev, kategori_id: data[0].id }));
      }
    } catch (error) {
  ...
  return (
    <main className="container mx-auto p-4 md:p-8 font-sans">
      ...
      <div className="flex justify-center gap-4 mb-8">
        ...
        <Link href="/kategori" className="bg-indigo-600 text-white px-5 py-2 rounded-md hover:bg-indigo-700 font-semibold shadow-sm">
          Kelola Kategori
        </Link>
      </div>
